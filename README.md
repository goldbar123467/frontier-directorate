...
The repository is currently at **Gate Zero**. Production implementation is
forbidden until the specification package in `docs/` is independently reviewed
and the gate evidence report records approval.
